...
from introuter.p4_pd_rpc.ttypes import *
...
class BaseTest(pd_base_tests.ThriftInterfaceDataPlane):
    def __init__(self):
        pd_base_tests.ThriftInterfaceDataPlane.__init__(self, ["introuter"])
    ...
    def popTables(self):
        ...
        for e in entries:
            ...
            match_spec = globals()['introuter_%s_match_spec_t' % table_name]

            if 'action_params' in e:
                act_spec = globals()['introuter_%s_action_spec_t' % act_name]
